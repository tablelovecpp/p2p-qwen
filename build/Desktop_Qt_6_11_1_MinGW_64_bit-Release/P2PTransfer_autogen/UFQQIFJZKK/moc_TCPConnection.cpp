...
void TCPConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TCPConnection::*)(const QByteArray & )>(_a, &TCPConnection::dataReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPConnection::*)()>(_a, &TCPConnection::connected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPConnection::*)()>(_a, &TCPConnection::disconnected, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TCPConnection::*)(const QString & )>(_a, &TCPConnection::errorOccurred, 3))
            return;
    }
}
...
// SIGNAL 0
void TCPConnection::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 3
void TCPConnection::errorOccurred(const QString & _t1)
{
